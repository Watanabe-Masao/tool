...
import {
  handleStep,
  handleFixedCalculateStep1,
  handleFixedDirectStep1,
  handleWeightCalculateStep1,
...
function handleStep1() {
  handleFixedCalculateStep1(handleProductCalculation);
}
...
function handleStep2() {
  handleStep(MODE.FIXED, 'calculate', 2, handleProductCalculation);
}
...
function handleStep3() {
  handleStep(MODE.FIXED, 'calculate', 3, handleProductCalculation);
}
...
function handleDirectStep1() {
  handleFixedDirectStep1(handleProductCalculation);
}
...
function handleDirectStep2() {
  handleStep(MODE.FIXED, 'direct', 2, handleProductCalculation);
}
...
function handleDirectStep3() {
  handleStep(MODE.FIXED, 'direct', 3, handleProductCalculation);
}
...
function handleWeightStep1() {
  handleWeightCalculateStep1(handleProductCalculation);
}
...
function handleWeightStep2() {
  handleStep(MODE.WEIGHT, 'calculate', 2, handleProductCalculation);
}
...
function handleWeightStep3() {
  handleStep(MODE.WEIGHT, 'calculate', 3, handleProductCalculation);
}
...
function handleWeightDirectStep1() {
  handleStep(MODE.WEIGHT, 'direct', 1, handleProductCalculation);
}
...
function handleWeightDirectStep2() {
  handleStep(MODE.WEIGHT, 'direct', 2, handleProductCalculation);
}
...
function handleWeightDirectStep3() {
  handleStep(MODE.WEIGHT, 'direct', 3, handleProductCalculation);
}
