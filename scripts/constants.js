...
export const STEP_CONFIG = {
  ...
  FIXED_CALCULATE: {
    mode: MODE.FIXED,
    method: YIELD_METHOD.CALCULATE,
    fields: FIXED_FIELDS.CALCULATE,
    steps: {
      step1: {
        input: UI_ELEMENTS.FIXED_STEP1,
        result: UI_ELEMENTS.FIXED_STEP1_RESULT,
        resultFields: {
          beforeCost: UI_ELEMENTS.BEFORE_COST_STEP1,
          beforePrice: UI_ELEMENTS.BEFORE_PRICE_STEP1,
          beforeMarkup: UI_ELEMENTS.BEFORE_MARKUP_STEP1
        }
      },
      step2: {
        input: UI_ELEMENTS.FIXED_STEP2,
        result: UI_ELEMENTS.FIXED_STEP2_RESULT,
        resultFields: {
          yieldRate: UI_ELEMENTS.YIELD_RATE_STEP2
        }
      },
      step3: {
        input: UI_ELEMENTS.FIXED_STEP3,
        result: UI_ELEMENTS.FIXED_STEP3_RESULT,
        resultFields: {
          afterCost: UI_ELEMENTS.AFTER_COST_STEP3,
          afterPrice: UI_ELEMENTS.AFTER_PRICE_STEP3,
          afterMarkup: UI_ELEMENTS.AFTER_MARKUP_STEP3
        }
      }
    }
  },
  ...
  FIXED_DIRECT: {
    mode: MODE.FIXED,
    method: YIELD_METHOD.DIRECT,
    fields: FIXED_FIELDS.DIRECT,
    steps: {
      step1: {
        input: UI_ELEMENTS.FIXED_DIRECT_STEP1,
        result: UI_ELEMENTS.FIXED_DIRECT_STEP1_RESULT
      },
      step2: {
        input: UI_ELEMENTS.FIXED_DIRECT_STEP2,
        result: UI_ELEMENTS.FIXED_DIRECT_STEP2_RESULT,
        resultFields: {
          yieldRate: UI_ELEMENTS.YIELD_RATE_DIRECT_STEP2,
          beforeCost: UI_ELEMENTS.BEFORE_COST_DIRECT_STEP2,
          beforePrice: UI_ELEMENTS.BEFORE_PRICE_DIRECT_STEP2,
          beforeMarkup: UI_ELEMENTS.BEFORE_MARKUP_DIRECT_STEP2
        }
      },
      step3: {
        input: UI_ELEMENTS.FIXED_DIRECT_STEP3,
        result: UI_ELEMENTS.FIXED_DIRECT_STEP3_RESULT,
        resultFields: {
          afterCost: UI_ELEMENTS.AFTER_COST_DIRECT_STEP3,
          afterPrice: UI_ELEMENTS.AFTER_PRICE_DIRECT_STEP3,
          afterMarkup: UI_ELEMENTS.AFTER_MARKUP_DIRECT_STEP3
        }
      }
    }
  },
  ...
  WEIGHT_CALCULATE: {
    mode: MODE.WEIGHT,
    method: YIELD_METHOD.CALCULATE,
    fields: WEIGHT_FIELDS.CALCULATE,
    displayElement: UI_ELEMENTS.PER_100G_DISPLAY,
    steps: {
      step1: {
        input: UI_ELEMENTS.WEIGHT_STEP1,
        result: UI_ELEMENTS.WEIGHT_STEP1_RESULT,
        resultFields: {
          beforeCost: UI_ELEMENTS.BEFORE_COST_WEIGHT_STEP1,
          beforePrice: UI_ELEMENTS.BEFORE_PRICE_WEIGHT_STEP1,
          beforeMarkup: UI_ELEMENTS.BEFORE_MARKUP_WEIGHT_STEP1
        }
      },
      step2: {
        input: UI_ELEMENTS.WEIGHT_STEP2,
        result: UI_ELEMENTS.WEIGHT_STEP2_RESULT,
        resultFields: {
          yieldRate: UI_ELEMENTS.YIELD_RATE_WEIGHT_STEP2
        }
      },
      step3: {
        input: UI_ELEMENTS.WEIGHT_STEP3,
        result: UI_ELEMENTS.WEIGHT_STEP3_RESULT,
        resultFields: {
          afterCost: UI_ELEMENTS.AFTER_COST_WEIGHT_STEP3,
          afterPrice: UI_ELEMENTS.AFTER_PRICE_WEIGHT_STEP3,
          afterMarkup: UI_ELEMENTS.AFTER_MARKUP_WEIGHT_STEP3
        }
      }
    }
  },
  ...
  WEIGHT_DIRECT: {
    mode: MODE.WEIGHT,
    method: YIELD_METHOD.DIRECT,
    fields: WEIGHT_FIELDS.DIRECT,
    displayElement: UI_ELEMENTS.PER_100G_DISPLAY_DIRECT,
    steps: {
      step1: {
        input: UI_ELEMENTS.WEIGHT_DIRECT_STEP1,
        result: UI_ELEMENTS.WEIGHT_DIRECT_STEP1_RESULT,
        resultFields: {
          beforeCost: UI_ELEMENTS.BEFORE_COST_WEIGHT_DIRECT_STEP1,
          beforePrice: UI_ELEMENTS.BEFORE_PRICE_WEIGHT_DIRECT_STEP1,
          beforeMarkup: UI_ELEMENTS.BEFORE_MARKUP_WEIGHT_DIRECT_STEP1
        }
      },
      step2: {
        input: UI_ELEMENTS.WEIGHT_DIRECT_STEP2,
        result: UI_ELEMENTS.WEIGHT_DIRECT_STEP2_RESULT,
        resultFields: {
          yieldRate: UI_ELEMENTS.YIELD_RATE_WEIGHT_DIRECT_STEP2
        }
      },
      step3: {
        input: UI_ELEMENTS.WEIGHT_DIRECT_STEP3,
        result: UI_ELEMENTS.WEIGHT_DIRECT_STEP3_RESULT,
        resultFields: {
          afterCost: UI_ELEMENTS.AFTER_COST_WEIGHT_DIRECT_STEP3,
          afterPrice: UI_ELEMENTS.AFTER_PRICE_WEIGHT_DIRECT_STEP3,
          afterMarkup: UI_ELEMENTS.AFTER_MARKUP_WEIGHT_DIRECT_STEP3
        }
      }
    }
  }
